...
public class ShopMain {
	...
	public static String excellPath = "src\\persons.xlsx";
	public static String file = "persons.xlsx";
	...
	private static XSSFCell cell;
	 ...
	 // Method to get file from persons.xlsx
	public static boolean getFile(String path) {
		...
		try {
			...
			System.out.println(e.toString());
			System.out.println("Nije otvoren fajl.");
			return false;
		}
	}

	  // Method to get Sheet from persons.xlsx
	public static boolean getSheet(int index) {
		try {
			...
			System.out.println(e.toString());
			System.out.println("Ne otvara worksheet");
			return false;
		}
	}
